...
const EventsSection = () => {
  return (
    <section className="py-12 px-4 md:px-6 ">
      <div className="max-w-5xl mx-auto space-y-8 flex flex-col">
        ...
        <LinkWithUnderline href="/veranstaltungen" className="self-end" spanClassName=" flex items-center gap-1 pb-1" >
