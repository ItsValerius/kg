...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-gray-950 text-black dark:text-gray-50 py-6 px-4 md:px-6 flex flex-col sm:flex-row items-center justify-between border-t shadow-inner">
